...
import com.dream.dreamshops.service.image.IImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> updateImagee(@PathVariable Long imageId, @RequestBody MultipartFile file){
        try {
            Image image = imageService.getImageById(imageId);
            if(image != null){
